[Netflix](https://netflix.com/ "Netflix")[Help Center](https://help.netflix.com/en)

[Join Netflix](https://help.netflix.com/signup) [Sign In](https://netflix.com/Login?nextpage=https%3A%2F%2Fhelp.netflix.com%2Flegal%2Fprivacy)
...
To see our [US State Privacy Notice](https://help.netflix.com/en/legal/privacy#us), including “Notice at Collection” details, please click on the link, go to [netflix.com/privacy#states](https://help.netflix.com/en/legal/privacy#states), or scroll down to the “Supplemental Privacy Disclosures for US Residents” section.

### Contacting Us

For questions about this Privacy Statement, our use of your personal information, or how to exercise [your privacy rights](https://help.netflix.com/en/legal/privacy#rightsandcontrols), please contact our Data Protection Officer/Privacy Office at [privacy@netflix.com](mailto:privacy@netflix.com). For general questions about the Netflix service, your account, or how to contact customer service, please visit [help.netflix.com](https://help.netflix.com/).
...
- From other sources: We may collect the following [categories of personal information](https://help.netflix.com/en/legal/privacy#categories) about you from other sources: personal details, payment details, and device and network information. These sources include:
...
- Safety, security and fraud prevention: Netflix and its Service Providers may disclose your personal information to third parties where we reasonably believe disclosure is needed for the [purpose](https://help.netflix.com/en/legal/privacy#howuse) of: safety, security, and fraud prevention.

- Compliance with law and enforcing the Netflix Terms of Use: We may disclose your personal information as necessary to comply with applicable law, regulation, legal process, or governmental request, and processing necessary to protect against harm to the rights, property or safety of Netflix, its users or the public, as required or permitted by law. We may disclose personal information for the following [purpose](https://help.netflix.com/en/legal/privacy#howuse): to comply with law and enforce the Netflix Terms of Use.
...
- Marketing of the Netflix service using cookies and similar technologies. To exercise choice around cookies or resettable device IDs collected for marketing of the Netflix service or Netflix content on third party service, please use the tools described in the “ [Cookies and other Technologies](https://help.netflix.com/en/legal/privacy#cookies)” section below.
...
To learn more about the types of cookies used by Netflix, please [click here](https://help.netflix.com/en/legal/privacy#cookie-preferences).
...
For more information about cookies set through our service and to exercise choices regarding cookies, [click here](https://help.netflix.com/en/legal/privacy#cookie-preferences). We do not currently respond to web browser “do not track" signals.
...
When you play Netflix games, we collect the [categories of personal information](https://help.netflix.com/en/legal/privacy#categories) described in the Netflix Privacy Statement. If you play games with the features mentioned above (or similar features), the following provides additional examples of the personal information we may collect:
...
When you play Netflix games, we [use personal information](https://help.netflix.com/en/legal/privacy#howuse) as described in the Netflix Privacy Statement. If you play games with the features mentioned above (or similar features), the following provides additional examples of how we may use your personal information:
...
At or before the time of collection, some US State Privacy Laws require that we provide a notice of our practices, including the [categories](https://help.netflix.com/en/legal/privacy#collect) of personal information collected, the [purposes](https://help.netflix.com/en/legal/privacy#uses) for which such information is collected or used, whether such information is [“sold” or “shared”](https://help.netflix.com/en/legal/privacy#soldorshared), and the criteria used to determine how long such information is [retained](https://help.netflix.com/en/legal/privacy#retention). We have provided these details throughout this section of the Privacy Statement.
...
We explain our sources of information in the section “ [Where We Collect Information From](https://help.netflix.com/en/legal/privacy#wherecollect)” above. For ease of reference, we collect the above categories of personal information from the following sources: directly from you; automatically when you use our service; from Partners whose products and service you use; from other sources such as Service Providers, Netflix Marketing Providers, third party sites and forums, and publicly available sources; and Advertising Companies.

### Uses of Personal Information

We use and have used in the past twelve months, each of the categories of personal information for one or more of the purposes described in the section “ [How We Use Your Personal Information](https://help.netflix.com/en/legal/privacy#howuse).” For ease of reference, we use the personal information to provide our service; to administer and operate our business; to research, analyze and improve our services; to enable partner integrations and promotions; to send marketing and informational messages; to support advertisements; for safety, security and fraud prevention; and to comply with law and enforce the Netflix Terms of Use.
...
We disclose and have disclosed in the past twelve months, the following categories of personal information for business purposes (see the section “ [Who We Disclose Personal Information To](https://help.netflix.com/en/legal/privacy#whodisclose)”): identifiers, Customer Records, characteristics of protected classifications, commercial information, internet activity information, geolocation data, audio/visual information and inferences.
...
You can assert these rights above when we receive a verified request from you. For information on how to exercise your rights, please see the [“Your Rights and Controls”](https://help.netflix.com/en/legal/privacy#rightsandcontrols) section of this Privacy Statement.
...
Select your preferred language:Select a languageEnglishSpanish (Latin America)
